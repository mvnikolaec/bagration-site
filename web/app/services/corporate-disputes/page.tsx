    ...
    <Section className="pt-20 pb-12 sm:pt-24 sm:pb-16">
      <Container>
        <div className="space-y-4">
          <Breadcrumbs items={[{ label: "Главная", href: "/" }, { label: "Услуги", href: "/services" }, { label: "Корпоративные споры" }]} />

          <h1 className="text-3xl font-semibold">Корпоративные споры</h1>
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-6 text-white/70">
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li>• Конфликты участников и органов управления</li>
              <li>• Доли/акции, оспаривание решений и сделок</li>
              <li>• Взыскание убытков, защита бизнеса</li>
              <li>• Арбитраж и досудебные переговоры</li>
            </ul>
          </div>
