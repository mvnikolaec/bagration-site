    ...
    <Section className="pt-20 pb-12 sm:pt-24 sm:pb-16">
      <Container>
        <div className="space-y-4">
          <Breadcrumbs items={[{ label: "Главная", href: "/" }, { label: "Услуги", href: "/services" }, { label: "Наследство" }]} />

          <h1 className="text-3xl font-semibold">Наследство</h1>
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-6 text-white/70">
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li>• Принятие наследства и восстановление сроков</li>
              <li>• Оспаривание завещания и действий нотариуса</li>
              <li>• Споры между наследниками, выдел долей</li>
              <li>• Судебная защита и оформление прав</li>
            </ul>
          </div>
