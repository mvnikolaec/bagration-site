    ...
    <Section className="pt-20 pb-12 sm:pt-24 sm:pb-16">
      <Container>
        <div className="space-y-4">
          <Breadcrumbs items={[{ label: "Главная", href: "/" }, { label: "Услуги", href: "/services" }, { label: "Арбитраж" }]} />

          <h1 className="text-3xl font-semibold">Арбитраж</h1>
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-6 text-white/70">
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li>• Споры по договорам (поставка, подряд, услуги)</li>
              <li>• Взыскание задолженности, неустоек, убытков</li>
              <li>• Защита в суде и досудебные переговоры</li>
              <li>• Исполнение судебных актов</li>
            </ul>
          </div>
