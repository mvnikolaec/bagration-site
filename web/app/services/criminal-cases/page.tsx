    ...
    <Section className="pt-20 pb-12 sm:pt-24 sm:pb-16">
      <Container>
        <div className="space-y-4">
          <Breadcrumbs items={[{ label: "Главная", href: "/" }, { label: "Услуги", href: "/services" }, { label: "Уголовные дела" }]} />

          <h1 className="text-3xl font-semibold">Уголовные дела</h1>
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-6 text-white/70">
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li>• Защита на стадии проверки и следствия</li>
              <li>• Участие в допросах, обысках, очных ставках</li>
              <li>• Ходатайства, жалобы, обжалование мер пресечения</li>
              <li>• Защита в суде и апелляции</li>
            </ul>
          </div>
