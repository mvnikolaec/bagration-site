...
const PANEL_ID = "services-dropdown-panel";
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={`absolute left-0 top-full z-50 mt-1 min-w-[240px] rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-secondary)] py-2 shadow-lg ${
          open ? "block" : "hidden"
        }`}
      >
        <Link
